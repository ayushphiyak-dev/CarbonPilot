...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { 
    DS, ALL_ACTIONS, loadState, save, recalc, initTheme, applyTheme, toggleTheme, go, observeReveals, 
    updateChartColors, initCharts, renderDash, updateDashActions, selectStep, setAssess, restoreAssessForm, 
    renderAll, updateSim, restoreSim, resetSim, resetAssess, addTracked, removeTracked, renderActions, 
    openAddActionModal, closeAddActionModal, renderProgress, renderCoach, 
    getFp: () => fp, getCats: () => cats, getState: () => S,
    CAR_FACTOR, DIET_BASE, WASTE_MULT, HEAT_KG, SH_FACTOR
  };
}
